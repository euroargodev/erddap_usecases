...
Argo dataset ID: `ArgoFloats`

Argo reference dataset ID: `argo_reference`

Information about Argo dataset: 

- http://www.ifremer.fr/erddap/info/ArgoFloats/index.html

- http://www.ifremer.fr/erddap/info/argo_reference/index.html
...
You can run and edit example notebooks by running this repo on Binder (thanks [Pangeo](pangeo.io)):
...
## Ifremer ERDDAP request examples
